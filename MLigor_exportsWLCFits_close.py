...
for i in dictkeys:
	...
	ArrayedList = numpy.array([CharacterList1, CharacterList2, CharacterList3, CharacterList4, CharacterList5, CharacterList6, CharacterList7, CharacterList8, CharacterList9, CharacterList10, CharacterList11])
